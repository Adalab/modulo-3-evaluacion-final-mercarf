  ...
  return (
    <div className='leyend'>
      ...
      <ul className='leyend__list'>
        <li>
          <p>Humano</p>
          <img src={humanLogo} alt={props.species} className='detail-logo' />
        </li>
        <li>
          <p>Hombre</p>
          <img src={manLogo} alt={props.species} className='detail-logo' />
        </li>
        <li>
          <p>Mujer</p>
          <img
        ...
        <li>
          <p>Alien</p>
          <img src={alienLogo} alt={props.species} className='detail-logo' />
        </li>
        <li>
          <p>Alien Femenino</p>
          <img src={femaleLogo} alt={props.gender} className='detail-logo' />
        </li>
        <li>
          <p>Alien Masculino</p>
          <img src={maleLogo} alt={props.gender} className='detail-logo' />
        </li>
        <li>
          <p>Estado Desconocido</p>
          <img src={aliveLogo} alt={props.status} className='detail-logo' />
          <img src={unknownLogo} alt={props.status} className='detail-logo' />
          <img src={deathLogo} alt={props.status} className='detail-logo' />
        </li>
        <li>
          <p>Vivo</p>
          <img src={aliveLogo} alt={props.status} className='detail-logo' />
